...
{
    public class DialogOsobaEditViewModel:BaseViewModel
    {
        ...
        public DialogOsobaEditViewModel(OsobaViewModel osobaViewModel)
        {
            ConfirmCommand = new RelayCommand(Confirm, CanConfirm);
            CancelCommand = new RelayCommand(Cancel);

            Jmeno = osobaViewModel.Jmeno;
            Prijmeni = osobaViewModel.Prijmeni;
